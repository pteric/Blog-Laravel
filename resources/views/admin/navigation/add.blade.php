...
@section('content')
    ...
    {{--<div class="crumb_warp">--}}
        {{--<i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 添加友情导航--}}
    {{--</div>--}}
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/navigation')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="navigation_name">
                        <input type="text" name="navigation_alias" class="sm" >
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="" name="navigation_url" class="lg">
                    </td>
                </tr>
                <tr>
                    <th></th>
