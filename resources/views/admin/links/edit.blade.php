...
@section('content')
    ...
    {{--<div class="crumb_warp">--}}
        {{--<i class="fa fa-home"></i> <a href="#">首页</a> &raquo; 链接管理 &raquo; 编辑链接--}}
    {{--</div>--}}
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/links/' . $field->links_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th><i class="require">*</i>链接路径：</th>
                    <td>
                        <input type="text" value="{{$field->links_url}}" name="links_url">
                    </td>
                </tr>
                <tr>
                    <th><i class="require">*</i>描述：</th>
                    <td>
                        <textarea name="links_description" >{{$field->links_description}}</textarea>
                    </td>
                </tr>
                <tr>
                    <th></th>
